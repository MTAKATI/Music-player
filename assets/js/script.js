...
for (let i = 0, len = musicData.length; i < len; i++) {
  playlist.innerHTML += `
  <li> 
    <button class="music-item ${i === 0 ? "playing" : ""}" data-playlist-toggler 
...
const playlistTogglers = document.querySelector("[data-playlist-toggler]");
...
const playlistItems = document.querySelector("[data-playlist-item]");
...
playerRepeatBtn.addEventListener("click", repeat);ss